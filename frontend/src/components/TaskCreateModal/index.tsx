...
export default function TaskCreateModal({ open, onClose, onSubmit }: TaskCreateModalProps) {
        ...
        >
          ...
          >
            <div className="flex items-center justify-between">
              <h2 className="text-base font-black text-color-text-main dark:text-white">新しいタスク</h2>
              <button
                type="button"
                onClick={onClose}
                aria-label="閉じる"
